...
const words = [
  {
    text: "alibi",
    className: `text-new-orange font-semibold uppercase text-5xl lg:text-[4rem] font-latin`,
  },
  {
    text: "alisher",
    className: `font-semibold uppercase text-5xl lg:text-[4rem] font-latin`,
  },
];
    ...
    <main className="relative">
      ...
      <div className="relative mx-auto flex h-[70vh] max-w-6xl flex-col px-6 lg:h-screen lg:items-center lg:justify-center lg:pt-16">
        <TypewriterEffectSmooth
          className="absolute bottom-0 left-6 z-20 m-0 h-90 min-w-fit justify-center rounded-xl text-white lg:top-66 lg:left-3 lg:h-[65vh]"
          word={words[0]}
          gap={isMobile ? 8 : 12}
        />
        <TypewriterEffectSmooth
          className="absolute right-3 bottom-0 z-20 h-132 justify-center rounded-xl text-white lg:top-34 lg:right-3 lg:h-[85vh] lg:min-w-fit lg:text-xl"
          word={words[1]}
          gap={isMobile ? 8 : 12}
          transparentInside
        />
