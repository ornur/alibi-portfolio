...
const logos2 = logos.slice(
  Math.ceil(logos.length / 3),
  Math.ceil(logos.length / 3) * 2
);
...
export function LogosBanner() {
  ...
  return (
    <section
      id="companies"
      className="group relative m-auto mx-auto flex flex-col items-center overflow-x-hidden bg-background px-6 pb-16 md:py-32 lg:px-0"
      style={{ scrollbarGutter: "auto" }}
    >
      <p className="w-full text-center font-cyrillic text-3xl font-bold text-nowrap lg:text-6xl">
        {t("clients")}
      </p>
      <div className="relative space-y-24 lg:space-y-38 pt-16 md:w-full">
